...
class mobileMenu {
	constructor() {
		...
		document.querySelector('.siteHeaderMobile__searchInput').addEventListener('blur', (e)=>{
		...
		document.querySelector('.siteHeaderMobile__searchInput').addEventListener('focus', (e)=>{
			setTimeout( ()=> {
